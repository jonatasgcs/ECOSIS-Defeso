<?php
// ARQUIVO: php/admin_log_pesquisa.php
...
// Consulta o Log de Auditoria, FILTRANDO APENAS A TABELA RESPOSTAS_PESQUISA
$sql_log = "SELECT * FROM log_auditoria 
            WHERE tabela_origem = 'respostas_pesquisa' 
...
<head>
    ...
    <title>Auditoria de Pesquisas - TRIGGERS</title>
...
<body>
    <div class="container-admin">
        <h2 class="text-3xl font-bold text-center mb-6 text-gray-800">
            <i class="bi bi-gear-fill mr-2"></i> Auditoria de Pesquisas (TRIGGERS)
        </h2>
        
        <div class="mb-4">
            <p class="text-lg text-gray-700">Esta tabela mostra todas as ações de exclusão registradas automaticamente pelo **TRIGGER** na tabela de Respostas da Pesquisa.</p>
        </div>
        ...
        <a href="admin_pesquisa.php" class="text-blue-600 hover:text-blue-800 font-medium mt-6 inline-flex items-center">
            <i class="bi bi-arrow-left mr-2"></i> Voltar para Admin Pesquisas
        </a>
    </div>
</body>
</html>
